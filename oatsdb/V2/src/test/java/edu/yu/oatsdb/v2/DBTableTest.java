...
public class DBTableTest {
    ...
    @Test
    public void mapEntryReferenceViaPutIsStale() throws InstantiationException, SystemException, NotSupportedException,
            RollbackException {
        txMgr.begin();
        String a = "hi";
        Map<Character, String> map = db.createMap("arr", Character.class, String.class);
        map.put('A', a);
        String b = map.get('A');
        txMgr.commit();
        b = "new String();";
    ...
    @Test
    public void errorIsRolledBack() throws InstantiationException, SystemException, NotSupportedException,
            RollbackException {
        try {
            txMgr.begin();
            gradeDetail.put('=', "Hello");
    ...
    private void run() throws SystemException, NotSupportedException, RollbackException{
        txMgr.begin();
        assertNull(gradeDetail.get('='));
        txMgr.commit();
    }
}
